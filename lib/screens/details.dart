        ...
        children: [
         ...
         Positioned(
          ...
          child : Container(
            ...
            height: 50,
            color: Colors.white,
            child: Text("Pourcentage : ${myListElement.pourcentage}",style: const TextStyle(fontSize: 24)),
          ),
         ),
            Positioned(
          top: 600,
          ...
          child : Container(
            ...
            height: 50,
             color: Colors.white,
            child: Text("Note : ${myListElement.notes.toString()}",style: const TextStyle(fontSize: 24),),
          ),
